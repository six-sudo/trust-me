          ...
          <div className="hidden lg:block space-y-16">
            <div className="space-y-6">
              <h1 className="text-6xl lg:text-7xl font-black text-slate-900 mb-8 leading-[0.9] tracking-tight">
                Your Voice <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">Matters</span>
              </h1>
            ...
            <div className="grid grid-cols-2 gap-10">
              <div className="text-center group">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">Trust & Transparency</h3>
              ...
              <div className="text-center group">
                ...
                <h3 className="text-2xl font-bold text-slate-900 mb-3">Expert Recognition</h3>
                <p className="text-slate-600 text-lg leading-relaxed">
          ...
          <div className="bg-white/80 py-8 px-6 shadow-2xl rounded-3xl border border-white/20 w-full lg:w-auto relative overflow-hidden">
            ...
            <div className="lg:hidden text-center mb-6 relative z-10">
              <h1 className="text-3xl font-black text-slate-900 mb-2 tracking-tight">
                Join as a <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent">Reviewer</span>
              </h1>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* First Name Field */}
              <div className="group">
                <label htmlFor="firstName" className="block text-sm font-semibold text-slate-700 mb-2 tracking-wide">
                  First Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <FontAwesomeIcon icon={faUser} className="h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors duration-200" />
                  </div>
                  <input
                    id="firstName"
                    name="firstName"
              ...
              {/* Last Name Field */}
              <div className="group">
                <label htmlFor="lastName" className="block text-sm font-semibold text-slate-700 mb-2 tracking-wide">
                  Last Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                      ...
                      return (
                        <div
                          ...
                          className={`h-1.5 flex-1 rounded-full transition-all duration-300 ${
                            level <= strength
                              ? strength === 1
                                ? 'bg-gradient-to-r from-red-500 to-red-400 shadow-lg shadow-red-200'
                                : strength === 2
                                ? 'bg-gradient-to-r from-yellow-500 to-yellow-400 shadow-lg shadow-yellow-200'
                                : strength === 3
                                ? 'bg-gradient-to-r from-blue-500 to-blue-400 shadow-lg shadow-blue-200'
                                : 'bg-gradient-to-r from-emerald-500 to-emerald-400 shadow-lg shadow-emerald-200'
                              : 'bg-slate-200'
                          }`}
                        />
                      );
            ...
            <div className="group">
              <label htmlFor="confirmPassword" className="block text-sm font-semibold text-slate-700 mb-2 tracking-wide">
                Confirm Password
              </label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <FontAwesomeIcon icon={faCheckCircle} className="h-4 w-4 text-slate-400 group-focus-within:text-blue-500 transition-colors duration-200" />
                </div>
                <input
                  id="confirmPassword"
          ...
          >
            ...
            <div className="mt-6 text-center relative z-10">
              <p className="text-sm text-slate-600 font-medium">
                ...
                <a href="/login" className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 transition-all duration-200">
                  Sign in here
                </a>
              </p>
            </div>
