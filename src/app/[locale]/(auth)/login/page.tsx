          ...
          <div className="hidden lg:block space-y-16">
            <div className="space-y-6">
              <h1 className="text-6xl lg:text-7xl font-black text-slate-900 dark:text-gray-100 mb-8 leading-[0.9] tracking-tight">
                Welcome <span className="bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 dark:from-blue-400 dark:via-purple-400 dark:to-indigo-400 bg-clip-text text-transparent">Back</span>
              </h1>
            ...
            <div className="grid grid-cols-2 gap-10">
              <div className="text-center group">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-gray-100 mb-3">Your Reviews</h3>
              ...
              <div className="text-center group">
                ...
                <h3 className="text-2xl font-bold text-slate-900 dark:text-gray-100 mb-3">Trusted Status</h3>
                <p className="text-slate-600 dark:text-gray-300 text-lg leading-relaxed">
          ...
          <div className="bg-white/80 dark:bg-gray-900/80 py-8 px-6 shadow-2xl rounded-3xl border border-white/20 dark:border-gray-700/20 w-full lg:w-auto relative overflow-hidden">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-blue-600 focus:ring-blue-500 border-slate-300 dark:border-gray-600 dark:bg-gray-700 dark:checked:bg-blue-600 rounded"
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-slate-700 dark:text-gray-300 font-medium">
                    Remember me
                  </label>
                </div>

                <div className="text-sm">
                  <a href="/forgot-password" className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 dark:hover:from-blue-300 dark:hover:to-purple-300 transition-all duration-200">
                    Forgot password?
                  </a>
                </div>
              </div>
            ...
            <div className="mt-6 text-center relative z-10">
              <p className="text-sm text-slate-600 dark:text-gray-300 font-medium">
                ...
                <a href="/register" className="font-bold bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400 bg-clip-text text-transparent hover:from-blue-700 hover:to-purple-700 dark:hover:from-blue-300 dark:hover:to-purple-300 transition-all duration-200">
                  Sign up here
                </a>
              </p>
            </div>
