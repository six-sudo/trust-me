...
export default function BrandsPage() {
  ...
  return (
    <FrontendLayout className="bg-white">
      {/* Hero Section */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <h1 className="text-5xl md:text-6xl font-bold leading-tight">
                <div className="text-white">{t('hero.title.line1')}</div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t('whyChoose.subtitle')}</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.verifiedReviewers.title')}</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.qualityContent.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.targetedReach.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.analytics.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.secure.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('whyChoose.features.support.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('howItWorks.steps.createCampaign.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('howItWorks.steps.selectReviewers.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('howItWorks.steps.monitorProgress.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">{t('howItWorks.steps.getResults.title')}</h3>
              <p className="text-gray-600 leading-relaxed">
       ...
       <section className="py-20 relative overflow-hidden">
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="text-center mb-16">
             <h2 className="text-4xl font-bold text-gray-900 mb-4">{t('successStories.title')}</h2>
             <p className="text-xl text-gray-600 max-w-3xl mx-auto">{t('successStories.subtitle')}</p>
           </div>
           ...
           <div className="relative flex justify-center items-center min-h-[500px] perspective-1000">
             ...
             <div className="absolute left-0 transform transition-all duration-700 hover:scale-105 hover:z-20 group"
               ...
               <div className="relative w-80 h-96 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden group-hover:shadow-3xl transition-all duration-500">
                 <div className="absolute inset-0 bg-gradient-to-br from-blue-500/5 to-blue-700/10"></div>
                 <div className="relative p-8 h-full flex flex-col">
                   ...
                   <p className="text-gray-700 italic mb-6 text-base leading-relaxed flex-grow">
                     "{t('successStories.testimonials.techcorp.quote')}"
                   </p>
             ...
             <div className="relative z-10 transform transition-all duration-700 hover:scale-105 group"
               ...
               <div className="relative w-96 h-[28rem] bg-white rounded-3xl shadow-3xl border border-gray-100 overflow-hidden group-hover:shadow-4xl transition-all duration-500">
                 <div className="absolute inset-0 bg-gradient-to-br from-green-500/5 to-green-700/10"></div>
                 <div className="relative p-10 h-full flex flex-col">
                   <div className="flex items-center mb-8">
                     ...
                     <div className="ml-6">
                       <h4 className="font-bold text-gray-900 text-xl">Sarah Chen</h4>
                       <p className="text-gray-600 text-base">CEO, FashionForward</p>
                     </div>
                   </div>
                   <p className="text-gray-700 italic mb-8 text-lg leading-relaxed flex-grow">
                     "{t('successStories.testimonials.fashionforward.quote')}"
                   </p>
                   <div className="flex text-yellow-500 space-x-1">
                     {[...Array(5)].map((_, i) => (
             ...
             <div className="absolute right-0 transform transition-all duration-700 hover:scale-105 hover:z-20 group"
               ...
               <div className="relative w-80 h-96 bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden group-hover:shadow-3xl transition-all duration-500">
                 <div className="absolute inset-0 bg-gradient-to-br from-purple-500/5 to-purple-700/10"></div>
                 <div className="relative p-8 h-full flex flex-col">
                   <div className="flex items-center mb-6">
                     ...
                     <div className="ml-4">
                       <h4 className="font-bold text-gray-900 text-lg">Michael Rodriguez</h4>
                       <p className="text-gray-600 text-sm">Founder, HealthPlus</p>
                     </div>
                   </div>
                   <p className="text-gray-700 italic mb-6 text-base leading-relaxed flex-grow">
                     "{t('successStories.testimonials.healthplus.quote')}"
                   </p>
                   <div className="flex text-yellow-500 space-x-1">
                     {[...Array(5)].map((_, i) => (
                       <svg key={i} className="w-6 h-6 drop-shadow-sm" fill="currentColor" viewBox="0 0 20 20">
             ...
             <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
               <div className="flex items-center mb-6">
                 ...
                 <div className="ml-4">
                   ...
                   <p className="text-gray-600 text-sm">CEO, FashionForward</p>
                 </div>
               </div>
               <p className="text-gray-700 italic mb-4">
                 "{t('successStories.testimonials.fashionforward.quote')}"
       ...
       <CommonModal
         ...
         description={t('requestModal.description')}
         variant="default"
         size="lg"
         showFooter={true}
         maxHeight="90vh"
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
             ...
             <div>
               ...
               <select
                 ...
                 className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
               >
                 <option value="">{t('requestModal.form.industryPlaceholder')}</option>
                 <option value="technology">{t('requestModal.form.industries.technology')}</option>
                 <option value="fashion">{t('requestModal.form.industries.fashion')}</option>
                 <option value="health">{t('requestModal.form.industries.health')}</option>
                 <option value="food">{t('requestModal.form.industries.food')}</option>
                 <option value="beauty">{t('requestModal.form.industries.beauty')}</option>
                 <option value="travel">{t('requestModal.form.industries.travel')}</option>
                 <option value="finance">{t('requestModal.form.industries.finance')}</option>
                 <option value="education">{t('requestModal.form.industries.education')}</option>
                 <option value="other">{t('requestModal.form.industries.other')}</option>
               </select>
             </div>
             ...
             <div>
               ...
               <select
                 ...
                 className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent"
               >
                 <option value="">{t('requestModal.form.monthlyBudgetPlaceholder')}</option>
                 <option value="under-1k">{t('requestModal.form.budgets.under1k')}</option>
                 <option value="1k-5k">{t('requestModal.form.budgets.1k5k')}</option>
                 <option value="5k-10k">{t('requestModal.form.budgets.5k10k')}</option>
                 <option value="10k-25k">{t('requestModal.form.budgets.10k25k')}</option>
                 <option value="25k-50k">{t('requestModal.form.budgets.25k50k')}</option>
                 <option value="over-50k">{t('requestModal.form.budgets.over50k')}</option>
               </select>
             </div>
           </div>
