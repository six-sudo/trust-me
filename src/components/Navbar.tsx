        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            <div className="relative" ref={dotMenuRef}>
              <button
                ...
                className="p-2 text-gray-600 hover:text-blue-600 hover:bg-gray-100 rounded-full transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 cursor-pointer"
          ...
          <div className="md:hidden mr-4">
            <button
              ...
              className="bg-gray-200 inline-flex items-center justify-center p-3 rounded-md text-gray-600 hover:text-gray-700 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 cursor-pointer"
